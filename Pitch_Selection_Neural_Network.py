...
def get_pitcher_model(first_name, last_name):
	...
	def get_data(first_name, last_name):
		...
		train_data_input = train_data[['prev_pitch_3', 'prev_pitch_2', 'prev_pitch_2', 'balls', 'strikes', 'stand', 'on_3b', 'on_2b', 'on_1b', 'outs_when_up', 'pitch_number', 'pitch_code']].dropna()
		train_data_result = train_data_input[['pitch_code']]
		train_data_input = train_data_input[['prev_pitch_3', 'prev_pitch_2', 'prev_pitch_2', 'balls', 'strikes', 'stand', 'on_3b', 'on_2b', 'on_1b', 'outs_when_up', 'pitch_number']]

		test_data = test_data[['prev_pitch_3', 'prev_pitch_2', 'prev_pitch_2', 'balls', 'strikes', 'stand', 'on_3b', 'on_2b', 'on_1b', 'outs_when_up', 'pitch_number', 'pitch_code']].dropna()
	...
	def pre_process_data(train_data, train_data_result, test_data):
		...
		test_data[['prev_pitch_3', 'prev_pitch_2', 'prev_pitch_2', 'balls', 'strikes', 'stand', 'on_3b', 'on_2b', 'on_1b', 'outs_when_up', 'pitch_number']] = sc.fit_transform(test_data[['prev_pitch_3', 'prev_pitch_2', 'prev_pitch_2', 'balls', 'strikes', 'stand', 'on_3b', 'on_2b', 'on_1b', 'outs_when_up', 'pitch_number']])

		max_pitch_val = max(train_data_result['pitch_code'])

		train_data_result['pitch_code'] = train_data_result['pitch_code']/max_pitch_val
		test_data['pitch_code'] = test_data['pitch_code']/max_pitch_val

		return train_data, train_data_result, test_data, max_pitch_val
	...
	def create_model(train_data_input, train_data_result, saved_model_name):
		...
		# Fitting our model 
		model.fit(train_data_input, train_data_result, batch_size = 1000, nb_epoch = 100)
	...
	def test_model(data, model, max_val):
		model.compile(optimizer = 'adam', loss = 'binary_crossentropy', metrics = ['accuracy'])
		model_data = data[['prev_pitch_3', 'prev_pitch_2', 'prev_pitch_2', 'balls', 'strikes', 'stand', 'on_3b', 'on_2b', 'on_1b', 'outs_when_up', 'pitch_number']]
		predict = model.predict(model_data)
		data['predict_type'] = predict
		data *= max_val
		return data[['pitch_code', 'predict_type']]
	...
	train_data_input, train_data_result, test_data, max_pitch_val = pre_process_data(train_data_input, train_data_result, test_data)
	...
	test_data = test_model(test_data, model, max_pitch_val)
	print(test_data)
	return test_data
